...
//         joinDate: formatJoinDate(Date.now()), // Using current time as join date for demo
//         bio: 'Passionate about algorithms and competitive programming',
//         photoURL: user.photoURL || 'https://via.placeholder.com/150',
//         recentSubmissions: [
//           { problem: 'Two Sum', language: 'Python', status: 'Accepted', runtime: '45ms', date: '2024-03-15' },
//           { problem: 'Valid Parentheses', language: 'JavaScript', status: 'Accepted', runtime: '32ms', date: '2024-03-14' },
//           { problem: 'Merge Sort', language: 'Java', status: 'Wrong Answer', runtime: 'N/A', date: '2024-03-13' },
//           { problem: 'Binary Search', language: 'Python', status: 'Accepted', runtime: '28ms', date: '2024-03-12' },
//           { problem: 'Linked List Cycle', language: 'C++', status: 'Accepted', runtime: '12ms', date: '2024-03-11' }
//         ],
//         stats: {
//           totalSubmissions: 42,
...
//       case 'Wrong Answer': return 'text-red-600 bg-red-100 dark:text-red-400 dark:bg-red-900/30';
//       case 'Runtime Error': return 'text-yellow-600 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-900/30';
...
//           <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Please sign in to view your profile</h2>
//           <p className="text-gray-600 dark:text-gray-400">You need to be authenticated to access this page.</p>
//         </div>
//       </div>
//     );
//   }
...
//                 <p className="text-gray-600 dark:text-gray-400 text-lg">{profileData.bio}</p>

//                 {/* Stats Cards */}
//                 <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
//                   <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-xl">
//                     <div className="text-2xl font-bold">{profileData.stats.totalSubmissions}</div>
//                     <div className="text-sm opacity-90">Total Submissions</div>
//                   </div>
//                   <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-4 rounded-xl">
//                     <div className="text-2xl font-bold">{profileData.stats.acceptedSubmissions}</div>
//                     <div className="text-sm opacity-90">Accepted</div>
//                   </div>
//                   <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-4 rounded-xl">
//                     <div className="text-2xl font-bold">{profileData.stats.streak}</div>
//                     <div className="text-sm opacity-90">Day Streak</div>
//                   </div>
//                   <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-4 rounded-xl">
//                     <div className="text-2xl font-bold">{profileData.stats.rank}</div>
...
//                   {/* Activity Graph */}
//                   <div>
//                     <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Activity</h3>
...
//                             <Icons.Trophy />
//                           </div>
//                           <p className="text-gray-600 dark:text-gray-400 text-lg">Activity Graph Coming Soon</p>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//                       <select className="bg-white/70 dark:bg-gray-700/70 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 text-sm backdrop-blur-sm">
...
//                         <tr>
//                           <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Problem</th>
//                           <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Language</th>
//                           <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Status</th>
//                           <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Runtime</th>
...
//                               <div className="text-sm font-medium text-gray-900 dark:text-white">{submission.problem}</div>
//                             </td>
//                             <td className="px-6 py-4 whitespace-nowrap">
//                               <div className="text-sm text-gray-600 dark:text-gray-400">{submission.language}</div>
//                             </td>
//                             <td className="px-6 py-4 whitespace-nowrap">
...
//                             </td>
//                             <td className="px-6 py-4 whitespace-nowrap">
//                               <div className="text-sm text-gray-600 dark:text-gray-400">{submission.runtime}</div>
//                             </td>
//                             <td className="px-6 py-4 whitespace-nowrap">
...
//                   <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-8">Settings</h3>
...
//                         <div className="flex items-center justify-between">
//                           <div>
//                             <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Contest Reminders</label>
//                             <p className="text-sm text-gray-500 dark:text-gray-400">Get reminders for upcoming contests</p>
//                           </div>
//                           <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-blue-600">
//                             <span className="inline-block h-4 w-4 transform rounded-full bg-white transition-transform translate-x-6" />
//                           </button>
...
//                             />
//                           </div>
//                           <button className="mt-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200">
//                             Update Password
//                           </button>
//                         </div>
                        
//                         <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
//                           <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Two-Factor Authentication</h5>
//                           <div className="flex items-center justify-between">
//                             <div>
//                               <p className="text-sm text-gray-500 dark:text-gray-400">Add an extra layer of security to your account</p>
//                             </div>
//                             <button className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg text-sm hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
//                               Enable 2FA
//                             </button>
//                           </div>
//                         </div>
...
//                       <h4 className="text-lg font-medium text-red-700 dark:text-red-400 mb-4">Danger Zone</h4>
//                       <div className="space-y-4">
//                         <div className="flex items-center justify-between">
//                           <div>
//                             <label className="block text-sm font-medium text-red-700 dark:text-red-400 mb-1">Delete Account</label>
//                             <p className="text-sm text-red-600 dark:text-red-500">Permanently delete your account and all associated data</p>
//                           </div>
//                           <button 
//                             onClick={logout}
